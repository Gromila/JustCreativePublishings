...
namespace JustCreativePublishings.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IEmailService emailService)
            : this(new UserManager<User>(new UserStore<User>(new JustCreativePublishingsContext())), emailService)
        {
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", GlobalRes.BadUsernameOrPassword);
                }
            }
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? GlobalRes.PasswordChanged
                : message == ManageMessageId.SetPasswordSuccess ? GlobalRes.PasswordSet
        ...
        {
            using (var context = new JustCreativePublishingsContext())
            {
        ...
        {
            return ConfirmAccount(confirmationToken) ? View("RegistrationConfirmation") : View("ConfirmationFailure");
        }
    }
}