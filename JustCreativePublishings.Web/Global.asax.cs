...
using JustCreativePublishings.Web.App_Start;
using JustCreativePublishings.Web.Infrastructure;
...
namespace JustCreativePublishings.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            DependencyResolver.SetResolver(new ServicesDependencyResolver());
        }
    }
}
